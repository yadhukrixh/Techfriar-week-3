  ...
  return (
    <div>
      ...
      <div className={styles.bookingButtonsForMobile}>
        <button
          id="book-a-car"
          onClick={handleBookingVisible}
          className={isCarBookingVisible ? styles.active : ""}
        >
          Book a car
        </button>
      ...
      <div
        style={{ display: "none" }}
        id="mobile-pickup-options"
        className={isCarBookingVisible ? styles.mobilePickupOptions : ""}
      >
        ...
        <div className={styles.pickupTime}>
          ...
          <div className={styles.dateTime}>
            <span className={styles.date} id="selectedDate">
              Pick-up Date & Time
            </span>
          </div>
        </div>
        ...
        <div className={styles.pickupTime}>
          ...
          <div className={styles.dateTime}>
            <span className={styles.date} id="selectedArrivalDate">
              Drop off Time & Date
            </span>
          </div>
        </div>
